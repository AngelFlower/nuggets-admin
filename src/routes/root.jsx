    ...
    <>
      {loading ? (
        ...
        <div className="flex h-screen ">
          <div
            id="sidebar"
            className="flex flex-col w-64 h-screen py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600"
          >
            ...
            <div className="flex flex-col justify-between flex-1 mt-6">
              <nav>
                ...
                <button
                  className="flex items-center w-full px-4 py-2 mt-2 text-gray-600 rounded dark:text-gray-200 hover:bg-gray-700 hover:text-gray-200"
                  type="button"
                  onClick={async () => {
          ...
          <div id="detail" className="container px-3 py-3 mx-auto bg-gray-100">
